...
class Enemy(pygame.sprite.Sprite):
    ...
    def go_die(self, how, direction=1):
        ...
        if how in ['bumped', 'slided']:
            self.x_vel = C.ENEMY_SPEED * direction  # 死亡时敌人方向
            self.y_vel = -8
            self.gravity = 0.6
            self.state = 'die'
            self.frame_index = 2
...
class Goomba(Enemy):
    def __init__(self, x, y_bottom, direction, name, color):
        brown_rect_frames = [(0, 16, 16, 16), (16, 16, 16, 16), (32, 16, 16, 16)]
        blue_rect_frames = [(0, 48, 16, 16), (16, 48, 16, 16), (32, 48, 16, 16)]

        if not color:
            frame_rects = brown_rect_frames
        else:
            frame_rects = blue_rect_frames
...
class Koopa(Enemy):
    def __init__(self, x, y_bottom, direction, name, color):
        brown_rect_frames = [(96, 9, 16, 24), (112, 9, 16, 34), (160, 9, 16, 34)]
        blue_rect_frames = [(96, 72, 16, 24), (112, 72, 16, 24), (160, 72, 16, 24)]
